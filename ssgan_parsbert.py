# -*- coding: utf-8 -*-
"""SSGAN_parsBERT.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WnQVJWQw3ojmBbiDH2kY8AWqOX8Qyuh2
"""
...
os.system(cmd_str)
train_data = "./{}/train.csv".format(dataset)
...
labeled_data_const = int(percentage_labeled_data * len(train_examples))
...
def generate_data_loader(input_examples, label_masks, label_map, do_shuffle = False, balance_label_examples = False):
  ...
  for (text, label_mask) in examples:
    ...
    # print("label_map[text[1]] : ", label_map[str(text[1])])
...
for epoch_i in range(0, num_train_epochs):
    ...
    print_accuurracy(epoch_i+1,test_accuracy)
